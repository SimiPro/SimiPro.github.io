...
(function() {
    ...
    function init() {
        ...
        container = document.getElementById("PointToRectangle");
        ...
        projectedPoint = addSphere(0xffffff);
    ...
    function setNewProjectedPoint(position) {
        projectedPoint.position.set(position.x, position.y, position.z);
    ...
    function updateProjectedPoint() {
        const newP = pointToRectangle();
        setNewProjectedPoint(newP)
    }

    function pointToRectangle() {
